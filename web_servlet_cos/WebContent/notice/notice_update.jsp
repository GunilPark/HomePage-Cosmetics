	...
	<div id="member">
		...
		<div id="b_right">
			...
			<tr>
					...
					<td colspan="3">
						<input name="t_title" value="구매 절차 과정 안내 드립니다." type="text" class="inputBox_500">
					</td>
				</tr>
				<tr>
					<th><label for="t_content"><i class="fas fa-asterisk important"></i>Content</label></th>
					<td colspan="3">
						<textarea name="t_content" class="textArea_H250">제품 구매 절차 과정 안내.1. 회원가입 2. 목록조회3. 구매결정5. 물품수령</textarea>
					</td>
				</tr>
				<tr>
