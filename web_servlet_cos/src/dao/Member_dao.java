...
//            System.out.println("pw :"+temp.toString());	
	...
	public int memberPasswordUpdate(String id, String pw) {
	...
	public String getMemberName(String id, String tel_1, String tel_2, String tel_3) {
		String query = "select name from homepage_박건일_member\r\n" + 
				"where id='"+id+"'\r\n" + 
				"and tell_1 = '"+tel_1+"'\r\n" + 
				"and tell_2 = '"+tel_2+"'\r\n" + 
				"and tell_3 = '"+tel_3+"'";
	...
	//아이디 중복 검사
		...
		//비밀번호 확인 검사
		public int getPwCheck(String id,String pw) {
			int result = 0;
			String query = "select count(*)\r\n" + 
					"from HOMEPAGE_박건일_MEMBER\r\n" + 
					"where id = '"+id+"'\r\n" + 
